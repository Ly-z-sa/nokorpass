...
const js = `
    ...
    function initBooking() {
      ...
      const date = params.get('date') || ('Today, ' + new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'short' }));
    ...
    document.getElementById('checkoutBtn').addEventListener('click', function() {
      ...
      const movieDate = params.get('date') || ('Today, ' + new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'short' }));
...
<head>
  ...
  <title>Seat Selection — NokorPass</title>
...
fs.writeFileSync(path.resolve(__dirname, '../../booking.html'), html);
