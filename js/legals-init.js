/* 
  NokorPass Premium Cookie Consent 
  A high-end, glassmorphic banner for data privacy awareness.
*/

(function() {
  console.log("NokorPass Cookie Consent initializing...");
  try {
    if (localStorage.getItem('nokorpass-cookie-consent')) {
  ...
  const closeBanner = (status) => {
    localStorage.setItem('nokorpass-cookie-consent', status);
